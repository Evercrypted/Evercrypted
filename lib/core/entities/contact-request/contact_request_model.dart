...
class ContactRequest {
  ...
  String? get dbAuthorEmail {
    ...
    if (appKey == null) {
      ...
      return encryptForDb(authorEmail, appKey);
    }
  }
  ...
  set dbAuthorEmail(String? value) {
    ...
    if (appKey == null) {
      ...
      authorEmail = decryptForDb(value, appKey);
    }
  }
  ...
  String? get dbRecipientEmail {
    ...
    if (appKey == null) {
      ...
      return encryptForDb(recipientEmail, appKey);
    }
  }
  ...
  set dbRecipientEmail(String? value) {
    ...
    if (appKey == null) {
      ...
      recipientEmail = decryptForDb(value, appKey);
    }
  }
  ...
  String? get dbMessage {
    ...
    if (appKey == null) {
      ...
      return encryptForDb(message, appKey);
    }
  }
  ...
  set dbMessage(String? value) {
    ...
    if (appKey == null) {
      ...
      message = decryptForDb(value, appKey);
    }
  }
